...
report_types = models.Variable.get ('microspos_cc_api_calls', deserialize_json=True)
...
with DAG ("microspos_cc_data_load",
        ...
        for report_type in report_types:
            ...
            with TaskGroup (group_id=task_group) as STG_HSTG:
                ...
                data_load_lnd_raw = GCPCloudFunctionOperator(
                    ...
                    method='POST',
                    http_conn_id='dev_gcp_cf_dw_etl_microspos_CC_0_api_to_bq',
