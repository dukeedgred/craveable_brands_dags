...
brand_list = ["op","rr"]
find_unenriched_proc = "DEV_STG.XX_usp_find_unenriched_transactid"
update_unenriched_proc = "DEV_STG.XX_usp_update_unenriched_transactid"
        ...
        for brand in brand_list:
            ...
            with TaskGroup (group_id=task_group) as STG_HSTG:
                ...
                enrich_transactorid = GCPCloudFunctionOperator(
                    ...
                    method='POST',
                    http_conn_id='dev_gcp_cf_dw_etl_loyalty_enrich_transactid',
                ...
                export_sftp = GCPCloudFunctionOperator(
                    ...
                    method='POST',
                    http_conn_id='dev_gcp_cf_dw_etl_loyalty_export_sftp',
