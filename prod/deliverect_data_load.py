...
source_system_code = "DELIVERECT"
dlf_batch_name = source_system_code + "_DATA_LOAD_BATCH"


# DELIVERECT ONLY HAS 1 REPORT TYPE
# AIRFLOW VARIABLE CALLED "deliverect_report_types" TO CONTAIN LIST OF DELVIRECT REPORTS

#UPDATE BELOW LINE FOR NEW CODE
report_types = models.Variable.get ('deliverect_report_types', deserialize_json=True)

# BELOW CODE IS COMMETNED OUT "days_to_extract" NOT REQUIRED AS WE'RE SIMPLY TRIGGERING STORED PROCEDURES
...
default_dag_args = {
    "owner": dag_owner,
    'start_date': datetime(2023, 9, 20, 20, tzinfo=local_tz),
    'email_on_failure': True,
    'email_on_retry': False,
    "emails": ['julio.acuna@one51.com.au','peter.duong@one51.com.au'],
    'retries': 1,
    'retry_delay': timedelta(minutes=30),
    "depends_on_past": False
}

#UPDATE BELOW LINE WHEN NEW DAG IS BEING CREATED
with DAG ("deliverect_data_load",
