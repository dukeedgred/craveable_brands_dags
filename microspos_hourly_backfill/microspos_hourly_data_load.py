...
transaction_report_type = "getGuestChecks"

report_types = models.Variable.get ('microspos_hourly_api_calls', deserialize_json=True)

task_group_prefix = "LND_STG_HSTG_"
lndraw_prefix = "DEV_STG.LOAD_LND_" + source_system_code + "_"
lnd_prefix = "DEV_STG.LOAD_LND_HOURLY_" + source_system_code + "_"
stg_prefix = "DEV_STG.LOAD_STG_HOURLY_" + source_system_code + "_"
hstg_prefix = "DEV_STG.LOAD_HSTG_HOURLY_" + source_system_code + "_"
...
with DAG ("microspos_hourly_data_load",
    ...
    with TaskGroup(group_id=data_ingestion_package) as getguestchecks_data_ingestion_process:
        ...
        data_load_hourly_apis = GCPCloudFunctionOperator(
            ...
            method='POST',
            http_conn_id='dev_gcp_cf_dw_etl_microspos_1_hourly_api_to_bq',
